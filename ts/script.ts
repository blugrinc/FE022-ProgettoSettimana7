...
class User implements Smartphone {
    carica:number; //istanza
    numeroChiamate: number; 
    tariffa:number = 0.003 //centesimi al secondo , circa 0,20 al minuto 
...
chiama1?.addEventListener('click', () =>{
    start1()    
});

// TASTO PER CHIUDERE CHIAMATA
let chiudi1 = document.getElementById("chiudi1");
chiudi1?.addEventListener('click', () =>{//1) prendi il valore tempo e calcola la tariffa oraria
